...
DirectChaining(int size) {
  ...
  public void deleteKeyHashTable(String word) {
    ...
    if (result == true) {
      ...
      System.out.println("\n" + "\"" + word + "\"" + " is deleted from HashTable ");
    }
  }
  public static void main(String[] args) {
	    DirectChaining directChaining = new DirectChaining(13);
	    directChaining.insertHashTable("they");
	    directChaining.insertHashTable("are");
	    directChaining.insertHashTable("very");
	    directChaining.insertHashTable("lazy");
	    directChaining.insertHashTable("becuase");
