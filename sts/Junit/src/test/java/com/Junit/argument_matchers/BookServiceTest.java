package com.Junit.argument_matchers;
...
public class BookServiceTest {
	...
	@Test
	// here for date we are using any method
	...
	public void testStringTypeArgumentMatchers() {
		Book book = new Book("1234", "Mockito In Action", 600, LocalDate.now());
		when(bookRepository.findBookByTitleAndPriceAndIsDigital(contains("Action"), anyInt(), anyBoolean()))
				.thenReturn(book);
